<template>
  <b-container class="admin-books p-5">
    ...
    >
      <transition name="group-fade" mode="out-in">
        ...
        <books-table
          :books-data="allBooks"
          @data-changed="fetchBooks"
          v-else-if="booksAvailable"
        />
    ...
    <add-book @book-added="fetchBooks" />
  </b-container>
</template>
...
export default {
  ...
  methods: {
    ...
    openModal() {
      this.$bvModal.show("admin-add-books-modal");
    },
    hideModal() {
