        ...
        <b-col md="11">
          ...
          >
            ...
            >
              ...
              <b-row no-gutters v-if="user.school">
                <b-col md="6">
                  <label>School</label>
                </b-col>
                <b-col md="6">
              ...
              <b-row no-gutters v-if="user.subjectName">
                <b-col md="6">
                  <label>Subject</label>
                </b-col>
                <b-col md="6">
              ...
              <b-row no-gutters v-if="profile.challenges">
                <b-col md="6">
              ...
              <b-row no-gutters v-if="profile['challenge answered']">
                <b-col md="6">
                  <label>Challenges answered</label>
                </b-col>
                <b-col md="6">
                  <p>{{ profile["challenge answered"] }}</p>
                </b-col>
              </b-row>
...
export default {
  ...
  data() {
    return { state: { loading: false }, profile: {}, photo: null };
  },
  computed: {
    user() {
